...
public class DBUtil {
    ...
    public static int excuteUpdate(Connection conn,String sql, Object... objects) {
        ...
        try {
            ...
            LogWritter.bizError("DBUtil.excuteUpdate error: ",e);
        } finally {
    ...
    public static boolean excuteBatch(Connection conn,ArrayList sqlList) {
        ...
        try {
            ...
            LogWritter.bizError("DBUtil.excuteBatch error: ",e);
        } finally {
            close(stmt, null);
        }
        return false;
    ...
    public static int update(Connection conn,String sql) {
        ...
        try {
            ...
            LogWritter.bizError("DBUtil.update error: ",e);
        } finally {
            close(ps, null);
        }
        return 0;
    ...
    public static ResultSet queryForResultSet(Connection conn,String sql) {
        ...
        try {
            ...
            LogWritter.bizError("DBUtil.excuteQuery error: ",e);
        } finally {
            close(ps, rs);
        }
        return null;
    ...
    public static <T> T queryForObject(Connection connection,String sql, Class<T> clazz, Object... objects) {
        ...
        try {
            ...
            LogWritter.bizError("DBUtil.queryForObject error: ",e);
        } finally {
    ...
    public static <T> List<T> queryForList(Connection connection,String sql, Class<T> clazz, Object... objects) {
        ...
        try {
            ...
            while (resultSet.next()) {
                ...
                | NoSuchFieldException | NoSuchMethodException | InvocationTargetException e) {
            LogWritter.bizError("DBUtil.queryForList error: ",e);
        }  finally {
    ...
    public ArrayList<?> callStoreProcess(Connection conn,String procName, ArrayList<StoredProcParamObj> sqlParams, boolean commit) {
        ...
        try {
            ...
            LogWritter.bizError("DBUtil.callStoreProcess error: ",e);
            try {
                throw e;
            } catch (Exception e1) {
                LogWritter.bizError("DBUtil.callStoreProcess error2: ",e1);
            }
        } finally {
            try {
                if (conn != null) {
...
//					}
                ...
                LogWritter.bizError("DBUtil.callStoreProcess error3: ",ex1);
                try {
                    throw ex1;
                } catch (Exception e) {
                }
    ...
    private static void close(PreparedStatement preparedStatement, ResultSet resultSet) {
        try {
            ...
            LogWritter.bizError("DBUtil.close error: ",e);
        }
    }
